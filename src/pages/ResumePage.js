...
const ResumePage = () => {
    ...
    return (
        <>
            <Container className='px-3 d-flex justify-content-center flex-column d-none d-md-block'>
                <Row className='mt-5'>
                    <Col>
                ...
                <Row className='mt-5'>
                    ...
                    <Col className='ps-md-5 resume-text'>
                        ...
                        <ul style={{listStyle: 'none', padding: 0}} className='resume-text'>
                            <li className='my-1'><FaCircle style={{color: '#6C9BB3', width: '8px', height: '8px'}}/> &#160; FARAH ARCHITECTURE: Created and online business website and project gallery. <a target="_blank" href='https://www.faraharquitectura.com'>faraharquitectura.com</a></li>
                            <li className='my-1'><FaCircle style={{color: '#6C9BB3', width: '8px', height: '8px'}}/> &#160; FLECKS APPLIANCE CENTER: Added efficiency to the business by creating a react application to develop a responsive search feature giving customers access to products and information which solved many issues in the company. <a target="_blank" href='https://www.flecksappliancecenter.com'>flecksappliancecenter.com</a></li>
                            <li className='my-1'><FaCircle style={{color: '#6C9BB3', width: '8px', height: '8px'}}/> &#160; FADM IMPRESOS: Overhauled an existing site. Updated UI and UX to a user and mobile friendly environment. <a target="_blank" href='https://www.fadm.com.mx'>fadm.com.mx</a></li>
                        </ul>
                        <div className='resume-text'>
            ...
            {/* Mobile */}
            <Container className='px-3 d-flex justify-content-center flex-column d-block d-md-none'>
                <Row className='mt-3'>
                    <Col xs='12'>
                        <h1 style={{fontSize: '3rem'}}>Jake Dwyer</h1>
                        <h2 className='w-100' style={{fontSize: '2rem'}}>Software Developer</h2>
                    ...
                    <Col className='d-flex flex-column align-items-start'>
                        <p className='fw-normal alt-font my-0' style={{letterSpacing: '2px'}}> dwyerjakej@gmail.com  <AiOutlineMail /></p>
                        <p className='fw-normal alt-font my-0' style={{letterSpacing: '2px'}}>  jakedwyer.com  <BsBriefcase /></p>
                        <p className='fw-normal alt-font my-0' style={{letterSpacing: '2px'}}>dwyer-jake25 <AiOutlineLinkedin /> </p>
                    </Col>
                    <div className='my-3' style={{borderTop: `3px solid ${mainColor}`}}></div>
                    <Col xs='12' className='resume-text'>
                        <h3>Summary</h3>
                        <ul className='resume-text' style={{listStyle: 'none', padding: 0}}>
                            <li><FaCircle style={{color: '#6C9BB3', width: '7px', height: '7px'}}/> &#160; Frontend React developer.</li>
                            <li><FaCircle style={{color: '#6C9BB3', width: '7px', height: '7px'}}/> &#160; Fluent in English and Spanish.</li>
                            <li><FaCircle style={{color: '#6C9BB3', width: '7px', height: '7px'}}/> &#160; 2 years experience with html, css and javascript.</li>
                            <li><FaCircle style={{color: '#6C9BB3', width: '7px', height: '7px'}}/> &#160; 1+ year experience with React.</li>
                            <li><FaCircle style={{color: '#6C9BB3', width: '7px', height: '7px'}}/> &#160; Full stack certification (NodeJS, MongoDB, React and Express).</li>
                            <li><FaCircle style={{color: '#6C9BB3', width: '7px', height: '7px'}}/> &#160; 2 years experience with game development in C#.</li>
                            <li><FaCircle style={{color: '#6C9BB3', width: '7px', height: '7px'}}/> &#160; 8 years professional education experience.</li>
                        </ul>
                    </Col>
                    <div className='my-3' style={{borderTop: `3px solid ${mainColor}`}}></div>
                    <Col xs='12' className='resume-text'>
                    ...
                    <Col className='resume-text'>
                        ...
                        <h6>Recent Projects:</h6>
                        <ul style={{listStyle: 'none', padding: 0}} className='resume-text'>
                            <li className='my-3'><FaCircle style={{color: '#6C9BB3', width: '8px', height: '8px'}}/> &#160; <b>FARAH ARCHITECTURE</b>: Created and online business website and project gallery. <a target="_blank" href='https://www.faraharquitectura.com'>faraharquitectura.com</a></li>
                            <li className='my-3'><FaCircle style={{color: '#6C9BB3', width: '8px', height: '8px'}}/> &#160; <b>FLECKS APPLIANCE CENTER</b>: Added efficiency to the business by creating a react application to develop a responsive search feature giving customers access to products and information which solved many issues in the company. <a target="_blank" href='https://www.flecksappliancecenter.com'>flecksappliancecenter.com</a></li>
                            <li className='my-3'><FaCircle style={{color: '#6C9BB3', width: '8px', height: '8px'}}/> &#160; <b>FADM IMPRESOS</b>: Overhauled an existing site. Updated UI and UX to a user and mobile friendly environment. <a target="_blank" href='https://www.fadm.com.mx'>fadm.com.mx</a></li>
                        </ul>
                        <div className='resume-text'>
                            <h4 className='mt-4 mb-2'>Math and Spanish Educator</h4>
                            <h5>Oakville High School - St. Louis, MO - 2020 - 2022</h5>
