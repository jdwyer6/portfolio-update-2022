...
const PawPrintsPage = () => {
    return ( 
        <ProjectInfoPage 
            ...
            rationale="I wanted to create a fun project that reflected my interests. I love photography and the outdoors and I also have two awesome dogs named Pancho and Mati. This site allows the user to create a personalized canvas by selecting from a collection of images which best encapsulate themselves and their pet. The preview updates in real time so the user can see the changes they are making without reloading the page."
            img2={img2}
            img3={img3}
            img4={img4}
            img5={img5}
