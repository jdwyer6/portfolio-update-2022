...
const ProjectCard = ({ title, subtitle, tech, img, projectLink, githubLink, projectPage }) => {
    return ( 
        <>
            <Row className='d-flex align-items-center project-card mx-3 mx-md-5 my-3 my-md-5'>
                <Col lg='6' className='text-center my-3'>
                    ...
                    <Button as={Link} to={projectPage} className='col m-2 myBtn'><FaInfoCircle className='mb-1 me-1'/>Details</Button>
